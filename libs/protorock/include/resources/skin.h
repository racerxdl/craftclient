...
// https://github.com/Sandertv/gophertunnel/blob/master/internal/resource/skin.go

namespace ProtoRock {
namespace Resources {

// DefaultSkinResourcePatch holds the skin resource patch assigned to a player when they wear a custom skin.
const std::string DefaultSkinResourcePatch = R"({
   "geometry" : {
...
const std::string DefaultSkinGeometry = R"(
{
