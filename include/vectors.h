...
// class Vec2: public BaseVec<2> {
// public:
//     Vec2() {}
//     Vec2(float x, float y) { this->x = x; this->y = y; }
//     Vec2(const BaseVec<2> &vec) { for (int i = 0; i < 2; i++) { memory[i] = vec[i]; }}

//     void operator=(const BaseVec<2>& v1) { for (int i = 0; i < 2; i++) { this->memory[i] = v1[i]; }}
//     void operator=(const BaseVec<3>& v1) { for (int i = 0; i < 2; i++) { this->memory[i] = v1[i]; }}
//     void operator=(const BaseVec<4>& v1) { for (int i = 0; i < 2; i++) { this->memory[i] = v1[i]; }}
// };

// class Vec3: public BaseVec<3> {
// public:
//     Vec3() {}
//     Vec3(float x, float y, float z) { this->x = x; this->y = y; this->z = z; }
//     Vec3(const BaseVec<3> &vec) { for (int i = 0; i < 3; i++) { memory[i] = vec[i]; }}

//     void operator=(const BaseVec<2>& v1) { for (int i = 0; i < 2; i++) { this->memory[i] = v1[i]; } this->z = 0; }
//     void operator=(const BaseVec<3>& v1) { for (int i = 0; i < 3; i++) { this->memory[i] = v1[i]; }}
//     void operator=(const BaseVec<4>& v1) { for (int i = 0; i < 3; i++) { this->memory[i] = v1[i]; }}
// };

// class Vec4: public BaseVec<4> {
// public:
//     Vec4() {}
//     Vec4(float x, float y, float z, float w) { this->x = x; this->y = y; this->z = z; this->w = w; }
//     Vec4(const BaseVec<4> &vec) { for (int i = 0; i < 4; i++) { memory[i] = vec[i]; }}

//     void operator=(const BaseVec<2>& v1) { for (int i = 0; i < 2; i++) { this->memory[i] = v1[i]; } this->z = 0; this->w = 0; }
//     void operator=(const BaseVec<3>& v1) { for (int i = 0; i < 3; i++) { this->memory[i] = v1[i]; } this->w = 0;}
//     void operator=(const BaseVec<4>& v1) { for (int i = 0; i < 3; i++) { this->memory[i] = v1[i]; }}
// };
